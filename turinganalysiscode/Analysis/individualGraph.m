...
writefile='/home/michael/turingW/direct/individualChem3.txt';
writefile2='/home/michael/turingW/direct/resultsChem3.txt';
...
for n=1:sampleNum
    ...
    if patternType(n) == 0
        colorV='r';
    elseif patternType(n)==1
        colorV='m';
    elseif patternType(n)==2
        colorV='b';
    else
        colorV='g';
    end
    line([xp1 xp2],[yp1 yp2],'Color', colorV, 'LineWidth',4);
    xp1=Chemical(n);
end
...
ax = gca;
set(ax,'YTick',1:29);
set(ax,'YTickLabel',namesChem(1:29));
xlabel('Multiplier');
title('Phase Diagram');
fclose(res);
fclose(res2);
